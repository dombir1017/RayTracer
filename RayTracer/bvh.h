...
private:
	...
	{
		auto a_axiss_interval = a->bounding_box().axis_interval(axis_index);
		auto b_axiss_interval = b->bounding_box().axis_interval(axis_index);
		return a_axiss_interval.min < b_axiss_interval.min;
	}
